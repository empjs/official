...
:::info 💡 TIP
三个业务的demo仅仅只是部分依赖以及emp的配置不一样，您可以根据您的业务需求进行自由选择或者组合。
:::
...
当您的代码运行成功之后，它应该是这样子的🤩：<a target='_blank' href='https://mf-vue2.sc.empjs.dev/host/'>访问链接</a>
...
当您的代码运行成功之后，它应该是这样子的🤩：<a target='_blank' href='https://mf-vue2.sc.empjs.dev/app/'>访问链接</a>
